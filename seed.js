...
const seedData = {
    ...
    galleryGroups: [
      {
        ...
        subtitle: "Competition setups, racks and lifting stations",
        images: [
          "https://picsum.photos/seed/forge-gallery-1/800/600",
          "https://picsum.photos/seed/forge-gallery-2/800/600",
          "https://picsum.photos/seed/forge-gallery-3/800/600",
          "https://picsum.photos/seed/forge-gallery-4/800/600",
        ],
      },
      {
        title: "Recovery zone",
        subtitle: "Mobility, recovery and member comfort spaces",
        images: [
          "https://picsum.photos/seed/forge-gallery-5/800/600",
          "https://picsum.photos/seed/forge-gallery-6/800/600",
          "https://picsum.photos/seed/forge-gallery-7/800/600",
        ],
      },
    ],
    trainers: [
  ...
  contact: {
    ...
    whyChooseUs: [
      { title: "Evidence-based training", body: "Structured coaching and clear progression based on performance, not hype." },
      { title: "Expert trainers", body: "Real coaches on the floor guiding technique, accountability, and results." },
      { title: "Premium equipment", body: "Well-maintained strength and conditioning setup built for serious training." },
    ],
  },
};
